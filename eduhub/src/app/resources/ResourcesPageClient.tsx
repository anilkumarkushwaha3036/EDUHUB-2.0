...
export default function ResourcesPageClient() {
  ...
  useEffect(() => {
    Promise.all([fetchResourceTypes(), fetchSkills()]).then(([t, s]) => {
      setTypes(t);
      setSkills(s);
    });
  }, []);
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: "1.25rem" }}>
              ...
              >
                <button
                  className={`filter-pill ${selectedSkill === "" ? "active" : ""}`}
                ...
                {skills.map((s) => (
                  <button
                    key={s._id}
                    className={`filter-pill ${selectedSkill === s.slug ? "active" : ""}`}
                    onClick={() => handleSkillChange(s.slug)}
                    style={{ justifyContent: "flex-start" }}
                  >
                    {s.name}
                  </button>
            ...
            <div style={{ marginBottom: "1.25rem" }}>
              ...
              >
                ...
                {types.map((t) => (
                  <button
                    key={t._id}
                    className={`filter-pill ${selectedType === t.slug ? "active" : ""}`}
            ...
            <div>
              ...
              >
                {[
                  ...
                  <button
                    key={item.v}
                    className={`filter-pill ${selectedLevel === item.v ? "active" : ""}`}
                    onClick={() => handleLevelChange(item.v)}
                    style={{ justifyContent: "flex-start" }}
                  >
                    {item.l}
                  </button>
                        ...
                        style={{
                          ...
                          background:
                            page === i + 1
                              ...
                              : "transparent",
                          color:
                            page === i + 1 ? "#60a5fa" : "var(--text-muted)",
                          cursor: "pointer",
                          fontWeight: 600,
                        }}
                      >
