...
export default function FeaturedResourcesSection() {
  ...
  useEffect(() => {
    fetchResources({ featured: true, limit: 6 }).then((res) => setResources(res.data)).finally(() => setLoading(false));
  }, []);

  return (
    <section className="section" style={{ background: 'rgba(59,130,246,0.02)', borderTop: '1px solid rgba(59,130,246,0.06)', borderBottom: '1px solid rgba(59,130,246,0.06)' }}>
      <div className="container">
        ...
        >
          <div>
            <p style={{ fontSize: '0.8rem', color: '#06b6d4', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.5rem' }}>
              ⭐ Hand-picked
            </p>
